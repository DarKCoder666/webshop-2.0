    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-7xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'max-w-4xl rounded-2xl border border-border bg-card/70 backdrop-blur-xl shadow-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <Link
                                ...
                                <Image src="/billy.svg" alt="logo" width={100} height={20} className="invert dark:invert-0" />
                            </Link>
                        ...
                        <div className="bg-card in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-border p-6 shadow-2xl md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit md:items-center">
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className={cn('border-border text-muted-foreground hover:bg-muted hover:text-foreground', isScrolled && 'lg:hidden')}>
                                    <Link href="#">
                                        <span>Login</span>
                                    </Link>
                                </Button>
                                ...
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn('bg-primary text-primary-foreground hover:bg-primary/90', isScrolled ? 'lg:inline-flex' : 'hidden')}>
                                    <Link href="#">
