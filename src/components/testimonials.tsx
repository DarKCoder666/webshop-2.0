      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          {isBuilder ? (
            ...
            >
              {getRichTextContent(title) || "Meet our happy clients"}
            </EditableText>
          ) : (
            <RenderableText
              content={title || "Meet our happy clients"}
              as="h2"
              per="char"
              preset="fade-in-blur"
              className="text-4xl font-extrabold tracking-tight md:text-5xl"
          ...
          {isBuilder ? (
            ...
            >
              {getRichTextContent(subtitle) || "All of our 1000+ clients are happy"}
            </EditableText>
          ) : (
            <p className="mt-2 text-muted-foreground">{getRichTextContent(subtitle) || "All of our 1000+ clients are happy"}</p>
          )}
        </div>
