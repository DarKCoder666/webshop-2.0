      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          {isBuilder ? (
            ...
            >
              {getRichTextContent(title) || "Why Clients Love Us"}
            </EditableText>
          ) : (
            <RenderableText
              content={title || "Why Clients Love Us"}
              as="h2"
              per="char"
              preset="fade-in-blur"
              className="text-4xl font-extrabold tracking-tight md:text-5xl"
          ...
          {isBuilder ? (
            ...
            >
              {getRichTextContent(subtitle) || "Discover how customers use our products to build their businesses"}
            </EditableText>
          ) : (
            <p className="mt-2 text-muted-foreground">{getRichTextContent(subtitle) || "Discover how customers use our products to build their businesses"}</p>
          )}
        </div>
